...
// User routes
chatRouter.post("/", requireAuth, chatController.createRoom);
chatRouter.get(
  "/:roomId/messages",
  requireAuth,
...
chatRouter.patch("/:roomId/read", requireAuth, chatController.markAsRead);

// Vendor routes
chatRouter.get(
  "/vendor/:vendorId/:roomId/messages",
  requireAuth,
  isVendor,
  chatController.getMessages,
);
